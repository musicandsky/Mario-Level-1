...
class Level2(tools._State):
    ...
    def setup_pipes(self):
        ...
        self.pipe_group = pg.sprite.Group(pipe1)
    ...
    def setup_bricks(self):
        ...
        brick2 = bricks.Brick(4030, 365, c.SIXCOINS, self.coin_group)
        brick3 = bricks.Brick(4287, 365)
        brick4 = bricks.Brick(4330, 365, c.STAR, self.powerup_group)
        brick5 = bricks.Brick(5058, 365)
